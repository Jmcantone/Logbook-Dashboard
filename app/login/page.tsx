      ...
      <div className="w-full max-w-md p-8 space-y-8">
        <div className="text-center space-y-4">
          <div className="flex justify-center">
            <div className="p-4 bg-navy-800 rounded-full border border-navy-700">
              <Plane className="w-12 h-12 text-accent" />
            </div>
          </div>
          <h1 className="text-2xl font-bold text-white">Flight Logbook</h1>
          <p className="text-slate-400 text-sm">
            Juan Manuel Cantone Guzman
          </p>
          <p className="text-slate-500 text-xs">
            PPL(A) · ESP.FCL.00114944
          </p>
        </div>
        ...
        <p className="text-center text-slate-600 text-xs">
          Access restricted to authorized pilot only
        </p>
      </div>
    </div>
  );
